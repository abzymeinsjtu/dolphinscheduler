 ...
 */
public interface ProcessDefinitionV3Service {
     ...
     */
    QueryResult<ProcessDefinition> listProcessDefinitions(int userId,
                                                          long projectCode,
                                                          String searchVal,
                                                          int offset,
                                                          int maxResult);
    ...
    ProcessDefinition queryProcessDefinitionByCode(long projectCode,
                                         long code);
}
